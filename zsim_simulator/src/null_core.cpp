...
void NullCore::LoadFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, REG baseReg) {}
void NullCore::StoreFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, REG baseReg) {}
void NullCore::PredLoadFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, BOOL pred, REG baseReg) {}
void NullCore::PredStoreFunc(THREADID tid, ADDRINT addr, UINT32 size, ADDRINT base, BOOL pred, REG baseReg) {}
void NullCore::AfterStoreFunc(THREADID tid) {}
...
void NullCore::RegWriteFunc(THREADID tid, REG destReg, ADDRINT valueInBaseReg, INT64 offset, REG sourceReg, BOOL isClear) {}
