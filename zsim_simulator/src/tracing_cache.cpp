...
TracingCache::TracingCache(CC* _cc, CacheArray* _array, ReplPolicy* _rp, uint32_t _accLat, uint32_t _invLat, uint32_t _tagLat, g_string& _tracefile, g_string& _name) :
    Cache(_cc, _array, _rp, _accLat, _invLat, _tagLat, _name), tracefile(_tracefile)
{
